...
- [XCP](https://github.com/modelica/fmi-ls-xcp) &mdash; calibration and measurement
- [Network Communication](https://github.com/modelica/fmi-ls-bus) &mdash; simulation of network communication
- [Structure](https://github.com/modelica/fmi-ls-struct) &mdash; semantic grouping of variables
- [REF](https://github.com/modelica/fmi-ls-ref) &mdash; stimuli, reference results, and related files
