...
#TODO: Discuss if this example is necessary. Should there be examples for ME and CS as well? ... maybe even a common example that can point out the differences in theres three types?#
...
Thus for Scheduled Execution this attribute is mandatory for every Clock.
