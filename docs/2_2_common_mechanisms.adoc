...
_When computing the partial derivative with respect to the independent variable_ latexmath:[\mathbf{t}] _of the function_

[latexmath]
++++
\mathbf{f}(\mathbf{x}, \mathbf{\dot{v}}, \mathbf{t})
++++

_it's partial derivative with respect to_ latexmath:[\mathbf{t}] _will be_

[latexmath]
++++
\mathbf{\frac{\partial f}{\partial t}}
++++
...
[latexmath]
++++
\mathbf{\frac{\partial f}{\partial t} + \frac{\partial f}{\partial \mathbf{x}} \cdot \mathbf{\dot{v}}+\frac{\partial f}{\partial \mathbf{\dot{x}}} \cdot \mathbf{\ddot{v}}}
++++
_]_
