...
[NOTE]
====
<<outputClock,Output Clocks>> enable an FMU to provide a trigger to the outside world, e.g. to a <<triggered,triggered input Clock>> of another FMU. It is also allowd to assign variables to a triggered output clock.  +
