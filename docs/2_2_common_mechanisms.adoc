...
Contrary to the importer being the source of the clock activation, the definition of the clock timing comes from an FMU, either through the <<modelDescription.xml>>, calling <<fmi3GetInterval>>, or from another output clock connected to the input clock.
