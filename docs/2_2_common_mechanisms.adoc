...
For <<clocked-variable,clocked variables>>, setting and getting is only allowed during <<EventMode>> and when their respective Clocks are active.
One notable exception: During <<InitializationMode>>, <<clocked-variable,clocked variables>> can be set and get.
