...
_[Note that it is the partial deriavative and not the total derivative that is consedered.
 So when computing the partial derivative with respect to the independent variable latexmath:[t] of the function

[latexmath]
++++
f(\textbf{x}, \textbf{\dot{v}}, t)
++++

it's partial derivative with respect to t will be
...
[latexmath]
++++
\frac{\partial f}{\partial t} + \frac{\partial f}{\partial \textbf{x}} \cdot \textbf{\dot{v}}+\frac{\partial f}{\partial \textbf{dot{x}}} \cdot \textbf{\ddot{v}}
++++
]_
