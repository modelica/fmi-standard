...
* latexmath:[\mathbf{v}_{\mathit{known}}] is the vector of arguments of function latexmath:[\mathbf{f}] that could appear in <<dependencies>> in <<ModelStructure>> of the unknown variables latexmath:[\mathbf{v}_{\mathit{unknown}}].
