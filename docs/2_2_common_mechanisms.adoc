...
The importer informs the FMU about the Clock's `tunable` interval using <<fmi3SetInterval>> in <<InitializationMode>>. It can later change this interval in <<EventMode>> or <<ClockActivationMode>> +
