...
* `values` is a vector with the actual values of these variables. _[I.e. the concatenation of the variables (serialized in the case of arrays) in case multiple value references given.]_
