...
An FMU may inform the external scheduler that a <<triggered>> <<outputClock>> ticked by calling <<fmi3CallbackIntermediateUpdate>> with <<clocksTicked, `clocksTicked == fmi3True`>>.
