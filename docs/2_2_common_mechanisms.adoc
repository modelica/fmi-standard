...
latexmath:[\begin{align*}
\mathbf{x}_k(\mathbf{t}_{i}) &= \mathbf{f}_k(\mathbf{x}_k(\mathbf{t}_{i-1}), \mathbf{u}(\mathbf{t}_k), \mathbf{t}_k) \\
\mathbf{y}_k(\mathbf{t}_{i}) &= \mathbf{g}_k(\mathbf{x}_k(\mathbf{t}_{i-1}), \mathbf{u}(\mathbf{t}_k), \mathbf{t}_k)
\end{align*}]
...
latexmath:[\mathbf{y}_k(\mathbf{t}_{i}) = \mathbf{g}_k(\mathbf{f}_k(\mathbf{x}_k(\mathbf{t}_{i-1}), \mathbf{u}(\mathbf{t}_k), \mathbf{t}_k), \mathbf{u}(\mathbf{t}_k), \mathbf{t}_k)].
