...
The ability of FMUs to support more sophisticated simulation algorithms is characterized by a set of capability flags inside the XML description of the slave (see <<fmi-for-co-simulation>>).
