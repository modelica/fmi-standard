...
_[Clarification for FMI 2.0.1: The version string for FMUs generated acoording to FMI 2.0.1 shall be “2.0” to be compatible with FMI 2.0 importers.]_
...
Clarification for FMI 2.0.2: The `variableNamingConvention` `structured` does not define if arrays are 0-based or 1-based.
