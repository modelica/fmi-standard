...
An <<inputClock, `input clock`>>  can be left unconnected or only connected to an <<outputClock,`output clock`>>.
...
An <<outputClock,`output clock`>> can be left unconnected or only connected to an <<inputClock, `input clock`>>.
