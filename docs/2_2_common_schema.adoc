...
The value for this version is `3.0.0`.
Future maintenance / bugfix revisions are denoted as `3.0.1`, `3.0.2` ...
Future minor revisions are denoted as `3.1.x`, `3.2.x` ...
...
_For example the value for the FMI 3.0.0 Alpha 2 release is `3.0.0-alpha.2`.]_
