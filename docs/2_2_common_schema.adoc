...
===== Attributes intervalCounter, shiftCounter, resolution
...
[[discrete,`discrete`]]
`discrete`:: Model Exchange: The value of the variable is constant between external and internal events (= time, state, step events defined implicitly in the FMU). +
...
====== Attribute canHandleMultipleSetPerTimeInstant
