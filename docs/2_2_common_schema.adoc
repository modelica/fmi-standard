...
For more details on ModelStructure, see Section 2.2.8 on pages 55-59.
...
_[Note that this prevent any changes to the input before `fmi2EnterInitializationMode` is called.]_
