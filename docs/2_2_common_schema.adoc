...
[[system_overview]]
image::images/gen/fmiModelDescription_schema.png[width=70%]
...
image::images/gen/UnitDefinitions_schema.png[width=90%]
...
image::images/gen/DisplayUnit_schema.png[width=60%, align="center"]
...
image::images/gen/TypeDefinitions_schema.png[width=70%, align="center"]
...
image::images/gen/Int32_schema.png[width=50%, align="center"]

image::images/gen/Boolean_schema.png[width=50%, align="center"]

image::images/gen/Binary_schema.png[width=70%, align="center"]

image::images/gen/Enumeration_schema.png[width=75%, align="center"]
...
As an additional option for FMI for Hybrid Co-Simulation and FMI for Scheduled Co-Simulation discrete parts (that do not necessarily apply to synchronous clock theory) or continuous parts of the FMU can be associated to model partitions via <<clock,`clocks`>> whose ticks define the sampling points (i.e. communication points) for the variables of these model partitions.
...
[#TypeDefinitions]
image::images/gen/Clock_schema.png[width=55%, align="center"]
...
image::images/gen/LogCategories_schema.png[width=80%, align="center"]
...
image::images/gen/DefaultExperiment_schema.png[width=60%, align="center"]
...
image::images/gen/TerminalMemberVariable_schema.png[width=70%, pdfwidth=50%, align="center"]
...
image::images/gen/TerminalStreamMemberVariable_schema.png[width=80%, pdfwidth=60%, align="center"]
...
image::images/gen/GraphicalRepresentation_schema.png[width=100%, align="center"]
...
image::images/gen/ModelStructure_schema.png[width=80%, align="center"]
...
The attribute `name` must be unique with respect to all other elements of the `VendorAnnotation` list.
...
image::images/gen/ModelVariables_schema.png[width=60%, align="center"]
...
image::images/gen/fmi3VariableBase_schema.png[width=80%, align="center"]
...
Instead, its value is initialized with <<fmi3SetupExperiment>> and after initialization set by <<fmi3SetTime>> for Model Exchange and by arguments `currentCommunicationPoint` and `communicationStepSize` of <<fmi3DoStep>> for Co-Simulation FMUs.
...
// TODO: is the previous sentence cut off?
...
image::images/gen/Variable_Float64_schema.png[width=70%, align="center"]

image::images/gen/Variable_Int32_schema.png[width=70%, align="center"]

image::images/gen/Variable_Boolean_schema.png[width=70%, align="center"]

image::images/gen/Variable_Binary_schema.png[width=70%, align="center"]

image::images/gen/Variable_Enumeration_schema.png[width=70%, align="center"]
...
The optional part defines in which way <<derivative,`derivatives`>>, <<output,`outputs`>> and unitial unknowns depend on <<input,`inputs`>>, and continuous-time <<state,`states`>> at the current super-dense time instant (ME) or at the current communication point (xCS).
...
image::images/gen/ModelStructure_schema.png[width=90%]
