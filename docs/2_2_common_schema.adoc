...
|modelIdentifier
|The `modelIdentifier` of the `ModelExchange`, `BasicCoSimulation`, `HybridCoSimulation` or `ScheduledCoSimulation` elements this build configuration is associated with.
