...
The set of variables that share the same <<valueReference>> are called "alias set".
...
. All variables of the same alias set must have the same `<Dimension>` elements, or be scalar variables.
