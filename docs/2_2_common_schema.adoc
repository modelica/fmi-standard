...
Additional optional information about the graphical representation and the grouping of FMU variables into terminals is stored in the optional text file `terminalsAndIcons.xml` in XML format as specified by the XML schema file `fmi3TerminalsAndIcons.xsd`.
...
This is the root element of the XML file `terminalsAndIcons.xml`, and is defined as:
...
image::images/schema/CoordinateSystem.png[width=80%, align="center"]
...
image::images/schema/Icon.png[width=80%, align="center"]
