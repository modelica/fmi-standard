...
[[system_overview]]
#TODO: image_:images/fmiModelDescription_schema.png[]#
...
#TODO: image_:images/fmiModelDescription_schema_2.png[width=80%, align="center"]#
...
#TODO: image_::images/UnitDefinitions_schema.png[]#
...
#TODO: image_::images/BaseUnit_schema.png[width=50%, align="center"]#
...
#TODO: image_::images/DisplayUnit_schema.png[width=80%, align="center"]#
...
#TODO: image_::images/TypeDefinitions_schema.png[width=90%, align="center"]#
...
#TODO: image_::images/Real_schema.png[width=50%, align="center"]#

#TODO: image_::images/Integer_schema.png[width=50%, align="center"]#
...
#TODO: image_::images/Enumeration_schema.png[width=80%, align="center"]#
...
|The interval of triggered or inferred periodic clocks is defined with unsignedLong valued `intervalCounter` and `resolution`
...
[#TypeDefinitions]
#TODO: add image_:images/clock_variable.png[]#
...
#TODO: image_::images/LogCategories_schema.png[width=70%, align="center"]#
...
#TODO: image_::images/DefaultExperiment_schema.png[width=70%, align="center"]#
...
#TODO: image_::images/VendorAnnotations_schema.png[width=80%, align="center"]#
...
#TODO: image_::images/ModelVariables_schema.png[width=100%, align="center"]#
...
#TODO: image_::images/ScalarVariable_schema.png[width=90%, align="center"]#
...
- `"inferred"`: the variable defines an inferred clock that is controlled by the master.
Variability must be "clock".
Only a variable of type "Clock" can have this causality.

- `"triggered"`: the variable defines an triggered clock that is controlled by the FMU.
Variability must be "clock".
Only a variable of type "Clock" can have this causality.
...
If causality equals `inferred` the value for `initial` has to be set to "exact" and it is required to provide a start value for describing the expected initial contidion of master clocks for that FMU. If an inferred clock has `fmi3True` as an start value the master should activate the clock the first time it enters event mode. The master can nevertheless choose different start values if it is not possible to fulfill the conditions in a simulation setup.

If causality equals `triggered` the initial attribute value is set to `calculated` and no start value is provided.
...
If triggered clocks and inferred clocks of clockType equals `CPClock` are defined in the modelDescription.xml it is possible to define a tick relationship from a triggered clock to an aperiodic inferred clock based on `clockReference` (<<clock-relationships-for-communication-point-clocks>>).
This is done for aperiodic inferred clocks that have the clockType = `CPClock` via providing a list of valueReferences of triggered clocks of the same FMU.
If a triggered clock of this valueReference list ticks the master has to create a tick for the associated aperiodic inferred clock at the same time instant.
It is not allowed to combine triggered clocks with periodic or strict periodic inferred clocks based on `clockReference`.

The attribute clockReference must not be used if `causality` equals "triggered" for a variable.
...
#TODO: image_::images/Real_Schema_large.png[width=50%, align="center"]#

#TODO: image_::images/Integer_Schema_large.png[width=50%, align="center"]#

#TODO: image_::images/Boolean_Schema_large.png[width=50%, align="center"]#

#TODO: image_::images/String_Schema_large.png[width=50%, align="center"]#

#TODO: image_::images/Enumeration_Schema_large.png[width=50%, align="center"]#
...
#TODO: image_::images/Annotations_schema.png[width=80%]#
...
#TODO: image_::images/ModelStructure_schema.png[width=80%]#

`fmi3VariableDependency` is defined as:

#TODO: image_::images/Unknown_schema.png[width=80%]#

Elements of the `InitialUnknowns` list:

#TODO: image_::images/InitialUnknowns_schema.png[width=50%]#

#TODO: image_::images/Unknown_schema_2.png[width=80%]#
...
*TODO* is it helpful to include also clock dependencies here --> i.e. changing this variable will lead to a triggered clock tick.*TODO*
