...
Note that to state unitlessnes, the node should not have the attribute unit. 
Giving an empty string as a value is a valid unit that needs to be defined among the unit definition.]_
