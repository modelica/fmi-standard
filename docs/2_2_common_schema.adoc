...
_The rationale for requiring positive start values for <<structuralParameter, `structural parameters`>> that this avoids importers having to deal with vanishing dimensions if they do not want to deal with them (or even with changing sizes at all)._
