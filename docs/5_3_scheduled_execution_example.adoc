...
To ensure consistency it may be necessary to prevent preemption.
...
As for <<fmi3GetIntervalDecimal>> it may be necessary to ensure that the code is not preempted.
