...
[source, C]
----
include::examples/dummy.c[tags=Example5]
----
...
[source, C]
----
include::examples/dummy.c[tags=Example6]
----
...
[source, C]
----
include::examples/dummy.c[tags=Example7]
----
...
[source, C]
----
include::examples/dummy.c[tags=Example8]
----

[source, C]
----
include::examples/dummy.c[tags=Example9]
----
...
[source, C]
----
include::examples/dummy.c[tags=Example10]
----
