...
[source, C]
----
include::examples/se_example_sim_alg.c[tags=SE_Task10ms]
----
...
[source, C]
----
include::examples/se_example_sim_alg.c[tags=SE_IntermediateUpdate]
----
...
[source, C]
----
include::examples/se_example_fmu.c[tags=SE_ActivateMP]
----
...
[source, C]
----
include::examples/se_example_fmu.c[tags=SE_ActivateMP10ms]
----

[source, C]
----
include::examples/se_example_fmu.c[tags=SE_GetIntervalDecimal]
----
...
[source, C]
----
include::examples/se_example_fmu.c[tags=SE_GetClock]
----
