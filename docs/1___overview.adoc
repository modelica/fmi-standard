...
The Scheduled Co-Simulation interface exposes individual model partitions (e.g. tasks of a control algorithm), to be called by a master algorithm that acts as external scheduler.
The master algorithm is responsible for:
