...
The FMI Design Community has improved the FMI standard to react to new requirements from system simulation community.
...
* <<earlyreturn-co-simulation,early return>> from a <<fmi3DoStep>> call,
