...
==== Changes in FMI 3.0.x [[fmi-30x]]

Clarifications and fixes for all FMI 3.0 patch versions (FMI 3.0.x) are listed in the https://github.com/modelica/fmi-standard/releases[Release notes on Github.]
