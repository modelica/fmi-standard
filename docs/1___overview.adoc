...
This document defines the Functional Mock-up Interface (FMI), version 3.0.1. This is a maintenance release
for FMI 3.0. The changes w.r.t. FMI 3.0 (clarifications and bugfixes) are summarized on the release page for FMI 3.0.1
https://github.com/modelica/fmi-standard/releases/tag/3.0.1
