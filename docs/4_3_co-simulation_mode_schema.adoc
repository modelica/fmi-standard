...
===== Co-Simulation with Clock Support [[clocked-co-simulation-schema]]
...
===== Scheduled Excecution Simulation Support [[scheduled-execution-simulation-schema]]
...
===== Intermediate Variable Access [[intermediate-variable-access-schema]] 
variable capability flag: `intermediateAccess`  = `true/false`. 