...
After that the two clock variants are described.
The section ends with a short description of connecting clocked FMUs.
...
- The importer may execute both controller and plan fmus at times other than sample times as part of the time integration of the plant.
In this case, the controller must produce the zero order hold value u.
