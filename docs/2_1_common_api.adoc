...
_[When detecting illegal arguments or the wrong function call at the current state, the FMU may return <<fmi3Discard>> instead of <<fmi3Error>> to allow the importer to attempt an alternative call.]_
