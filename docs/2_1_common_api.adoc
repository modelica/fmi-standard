...
* latexmath:[\color{blue}{\mathbf{u}}] is the vector of unknown Real variables computed in the actual state:
...
* latexmath:[\color{blue}{\mathbf{k}] is the vector of Real <<input>> variables of function *h* that changes its value in the actual state.
