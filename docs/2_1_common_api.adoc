...
For Co-Simulation FMUs, additional functions are defined in <<transfer-of-input-output-and-parameter,`parameters`>> to set and inquire derivatives of variables with respect to time in order to allow interpolation.
