...
The number of <<state,`states`>> can change during simulation if it depends on one or more <<tunable>> structural parameters and can be retrieved after instantiating the FMU by calling:
