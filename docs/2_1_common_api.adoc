...
file can be inquired after calling `fmi2EnterInitializationMode` with the following functions (restrictions when calling of these functions is allowed might be present for the different FMI kinds, see below):
