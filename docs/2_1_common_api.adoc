...
_Still, `fmi3Set{VariableType}` functions could check whether the input arguments are valid (e.g. <<valueReferences>>) or in their validity range (e.g. between min and max as defined in the <<modelDescription.xml>>)._
