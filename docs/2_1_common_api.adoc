...
Can be returned only by `fmi3DoStep` and `fmi3GetDoStepPendingStatus` (see section 4.2.3).
...
===== Clock Types for Evaluation of Clocked Model Partitions
*Synchrounous Clocks*
