...
[#ExampleUseCase]
//TODO: add image:images/example_usecase.png[]
...
_[Example: Elementary blocks like a PI controller will have all variables on an inferred clock with identical properties._
