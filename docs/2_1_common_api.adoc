...
the multi-threaded environment that uses the FMU must guarantee that the calling sequences of functions defined in <<state-machine-model-exchange>> and section 4.2.4. are used.
