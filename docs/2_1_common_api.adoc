...
where latexmath:[\mathbf{v}_{unknwon}] are the latexmath:[m] unknowns and latexmath:[\mathbf{v}_{known}] are the latexmath:[n] knowns, and latexmath:[\mathbf{h}] is the function to calculate the unknowns from the knowns.
