...
- The importer may execute both controller and plant FMUs at times other than sample times as part of the time integration of the plant.
...
|`fmi3GetClock`
|Call during *Event Mode* and *Intermediate Update Mode*
