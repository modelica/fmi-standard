...
This function switches off all initialization equations, and the FMU enters implicitly *Event Mode* (for ME and HCS FMUs) resp. *Step Mode* (for BCS FMUs) resp. *Clock Activation Mode*.
