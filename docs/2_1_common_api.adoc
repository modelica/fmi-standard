...
Discrete-time states are listed in the ModelStructure and have the Variable xml-attribute `previous` referring to the variable holding the previous value of the state.
