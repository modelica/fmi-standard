...
It is the task of the simulation master to derive a computational order for the computation of two or more distict FMUs based on the local FMU clock priorities and input-output relationships of connected FMUs.
...
It is therefore imporatant to restrict the number of distinct priority levels for an FMU to available priority levels on the target platform. 
