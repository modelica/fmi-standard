...
_Efficient graph coloring algorithms are freely available, such as library http://www.cscapes.org/coloringpage/[ColPack] written in C/C++ (LGPL), or the routines by <<CGM84>>._
