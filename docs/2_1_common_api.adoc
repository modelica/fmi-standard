...
A handle uniquely identifies the value and other properties of of a variable, except for the variable name and the display unit that may differ for <<alias>> variable defintions.
