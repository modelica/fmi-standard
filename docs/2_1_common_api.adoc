...
It is only meaningful to combine one or multiple triggered clocks with a single aperiodic inferred clock in such a union. 
It is possible to define multiple unions of clocks, with the maximum number defined by the number of available aperiodic inferred clocks.
