...
(a) _Provides the directional derivative for all <<input>> variables; so in the above example: latexmath:[{\Delta y_1 = \frac{\partial g_1}{\partial x} \cdot \partial x + \frac{\partial g_1}{\partial u_1} \cdot \Delta u_1 + \frac{\partial g_1}{\partial u_3} \cdot \Delta u_3 + \frac{\partial g_1}{\partial u_4} \cdot \Delta u_4}]_
...
++++
\Delta Y(i,j) =
\frac{\partial Y}{\partial U(1,1)} \cdot \Delta U(1,1) +
\frac{\partial Y}{\partial U(1,2)} \cdot \Delta U(1,2) +
\frac{\partial Y}{\partial U(2,1)} \cdot \Delta U(2,1) +
\frac{\partial Y}{\partial U(2,2)} \cdot \Delta U(2,2)
++++
