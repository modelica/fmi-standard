...
The output arguments are not defined, but the computation can continue.
...
[[fmi3Error,`fmi3Error`]]
`fmi3Error`::
The call failed. All output arguments are undefined and the simulation cannot be continued.
