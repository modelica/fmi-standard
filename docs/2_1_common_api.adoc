...
then the [underline]#FMU# needs to be [underline]#recompiled# with the header file used by the [underline]#target simulator#.
+
...
_[This can be realized in the case of a source code FMU with a target-specific version of `fmi2Functions.h` that does not use FMI3_FUNCTION_PREFIX to construct the function names.]_
