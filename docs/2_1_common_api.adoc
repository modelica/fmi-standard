...
Additionally, a pointer to the environment is provided (componentEnvironment) that needs to be passed to
...
argument `componentEnvironment`. Argument `componentEnvironment` may be a null pointer.
