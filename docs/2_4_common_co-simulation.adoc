...
The set of variables for which the master can provide intermediate values is the set supplied through the <<intermediateVariableSetRequiredValueReferences>> argument to <<fmi3Instantiate>>.
...
The set of variables for which the master can get values is the set supplied through the <<intermediateVariableGetRequiredValueReferences>> argument to <<fmi3Instantiate>>.
