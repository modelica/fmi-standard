...
* Advanced interpolation/extrapolation techniques _[espcially providing the same functionality that was possible in FMI 2.0 with `fmi2SetInputDerivatives`, now perfoming the evalution of the approximation polynomial in the master compared with performing within the FMU as in FMI 2.0]_,
