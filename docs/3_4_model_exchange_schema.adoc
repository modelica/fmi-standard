...
The attributes in the following table are defined in addition to the <<common-capability-flags, common attributes>> and have the following meaning (all attributes are optional with exception of <<modelIdentifier>>):
