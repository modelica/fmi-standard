...
* <<clockReference>>: <<valueReference>> of an <<inputClock>> variable defined in the <<modelDescription.xml>> which shall be activated

* <<clockElementIndex>>: The element index of the <<inputClock>> variable which shall be activated.
