...
Is called before the start of the computation of a model partition for global variables and variables associated to the <<inputClock>> assigned to the model partition.
+
...
Is called after the end of the computation of a model partition for global variables and variables associated to the <<inputClock>> assigned to the model partition.
+
The restrictions related to variable <<causality>> and <<variability>> defined for *Step Mode* in <<fmi-for-co-simulation,`Co-Simulation`>> apply.
