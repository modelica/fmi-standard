...
If an <<outputClock>> with an attribute <<triggeredBy>> ticked, the scheduling algorithm schedules the model partition associated with the corresponding <<inputClock>>.
