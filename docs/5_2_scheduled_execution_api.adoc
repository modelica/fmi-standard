...
*#ToDo#* These function calls are allowed for <<tunable-clock,`tunable`>> and <<changing-aperiodic-clock,`changing`>> aperiodic Clocks.
...
*#ToDo#* These function calls are allowed for <<countdown-aperiodic-clock,`countdown`>> Clocks.
