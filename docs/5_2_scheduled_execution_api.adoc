...
[[fmi3CallbackRequestClockActivation,`fmi3CallbackRequestClockActivation`]]
Function `fmi3CallbackRequestClockActivation`::

+
[source, C]
----
include::../headers/fmi3FunctionTypes.h[tag=CallbackRequestClockActivation]
----
+
[[activateClockReferences,`activateClockReferences`]]
<<fmi3CallbackRequestClockActivation>> requests the importer to activate the Clocks specified in <<activateClockReferences>>.
