...
documentation                       // directory containing the documentation (optional)
   ...
   staticLinking.{txt|html}         // entry point for static linking information (optional)
appearance                          // FMU and terminal icons (optional)
...
===== Directory Appearance [[Appearance-directory]]

See <<fmiTerminalsAndIcons>> for a definition of the directory `appearance`.
