...
// TODO: Fix formatting of directory description
...
// TODO: Standard for license Description?
...
Exporters are encouraged to support multiple FMI types in one FMU, so it can be used in differently capable simulation algorithms and for different use cases.
