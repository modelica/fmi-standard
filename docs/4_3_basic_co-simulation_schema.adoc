...
|If `true`, the slave can be set to Hybrid Co-Simulation during instantiation of FMU.
...
|If `false`, the slave can be set to Basic Co-Simulation during instantiation of the FMU.
