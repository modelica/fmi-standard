...
The co-simulation algorithm collects the information about the number and properties of <<clock,`clocks`>> supported by the FMU by analyzing the <<modelDescription.xml>>, see <<table-overview-clocks>>.
