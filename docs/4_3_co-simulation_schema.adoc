...
|`languageVersion`
|C99, ... see Modelica standard 3.4, section 12.9
...
|`name`
|Name of the external dependency, e.g. name of an external library not contained in the FMU.
...
Element `ExternalDependency` optionally contains an element `VendorAnnotations` with tool specific data.
