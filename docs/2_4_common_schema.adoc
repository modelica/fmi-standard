...
If not defined and no other information about the nominal value is available, then `nominal = 1` is assumed. For array variables, all array members are assigned this nominal value. +
