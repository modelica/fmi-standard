...
For continuous variables this corresponds to that there exist values for the knowns where the paraial derivative of the unknwon with respect to a known is nonzero.
...
When listed among the dependencies this is not what is stated but rather that the unknowns partial derivative with respect to the indepenent varaiable can be non-zero.
For a mechanical system this correspnds to that the system is Rheonomous, while if there would be no listed depencies on the independent variable it is a Scleronomous system.]_
