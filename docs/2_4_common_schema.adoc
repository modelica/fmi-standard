...
_For example, an <<output>> Clock could be a clocked variable of another <<input>> clock to indicate that it can only be observed and activated when the <<input>> clock is active.]_
