...
Terminals are a <<VersioningLayered,layered standard>> that defines semantic groups of variables to ease connecting compatible signals on the system level.
