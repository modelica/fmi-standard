...
For <<fmi-for-scheduled-execution,Scheduled Execution>> the value of the independent variable is not defined _[since each <<model-partition>> has its own time]_.
_[The main purpose of this variable is to define a quantity and unit for the independent variable.]_
