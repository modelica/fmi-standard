...
When the independent variable is listed among the dependencies this implicit dependency is not what is ment, but rather that the unknown's partial derivative with respect to the independent variable can be non-zero.
