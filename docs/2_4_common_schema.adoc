...
image::schema/Annotations.png[width=800]
...
[[system_overview]]
image::schema/fmiModelDescription.png[width=750]
...
image::schema/UnitDefinitions.png[width=1000]
...
image::schema/BaseUnit.png[width=500]
...
image::schema/DisplayUnit.png[width=700]
...
image::schema/TypeDefinitions.png[width=700]
...
image::schema/Float64Type.png[width=1000]

.Int32Type element.
[[figure-schema-Int32Type]]
image::schema/Int32Type.png[width=1000]

.BooleanType element.
[[figure-schema-BooleanType]]
image::schema/BooleanType.png[width=1000]

.BinaryType element.
[[figure-schema-BinaryType]]
image::schema/BinaryType.png[width=1000]

.EnumerationType element.
[[figure-schema-EnumerationType]]
image::schema/EnumerationType.png[width=1000]

.ClockType element.
[[figure-schema-ClockType]]
image::schema/ClockType.png[width=1000]
...
image::schema/LogCategories.png[width=900]
...
image::schema/DefaultExperiment.png[width=550]
...
image::schema/ModelVariables.png[width=600]
...
image::schema/fmi3ArrayableVariable.png[width=800]
...
image::schema/Float64.png[width=700]

.Int32 element.
[[figure-schema-Int32]]
image::schema/Int32.png[width=700]

.Boolean element.
[[figure-schema-Boolean]]
image::schema/Boolean.png[width=700]

.Binary element.
[[figure-schema-Binary]]
image::schema/Binary.png[width=700]

.Enumeration element.
[[figure-schema-Enumeration]]
image::schema/Enumeration.png[width=700]

.Clock element.
[[figure-schema-Clock]]
image::schema/Clock.png[width=700]
...
image::schema/ModelStructure.png[width=1000]
...
image::schema/fmiTerminalsAndIcons.png[width=600]
...
image::schema/GraphicalRepresentation.png[width=1000]

====== CoordinateSystem

.CoordinateSytem element.
[[figure-schema-CoordinateSystem]]
image::schema/CoordinateSystem.png[width=650]
...
.Icon element.
[[figure-schema-Icon]]
image::schema/Icon.png[width=400]
...
image::GraphicalRepresentation.svg[width=600]
...
image::schema/Terminals.png[width=800]
...
image::schema/TerminalMemberVariable.png[width=700]
...
image::schema/TerminalStreamMemberVariable.png[width=800]
...
image::schema/TerminalGraphicalRepresentation.png[width=800]
...
image::schema/fmiBuildDescription.png[width=900]
...
image::schema/SourceFileSet.png[width=600]
...
.`SourceFile` element.
[[figure-SourceFile]]
image::schema/SourceFile.png[width=550]
...
image::schema/PreprocessorDefinition.png[width=650]
...
image::schema/IncludeDirectory.png[width=600]
...
.`Library` element.
[[figure-Library]]
image::schema/Library.png[width=550]
