...
Example: if latexmath:[{\frac{\text{ds}}{\text{dt}} = v,\ \frac{\text{dv}}{\text{dt}} =f(..)}],then latexmath:[{\left\{ v,\ \frac{\text{dv}}{\text{dt}} \right\}}] is the vector of state derivatives and attribute <<derivative>> of latexmath:[{v}] references latexmath:[{s}], and attribute <<derivative>> of latexmath:[{\frac{\text{dv}}{\text{dt}}}] references latexmath:[{v}].
