...
|[[needsWorkingDirectory,`needsWorkingDirectory`]] `needsWorkingDirectory`
|Defines whether the FMU needs a <<workingDirectory>>.
If `true`, <<workingDirectory>> must not be `NULL`.
|====
