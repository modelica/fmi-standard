...
The continuous <<state,states>> of an FMU and their derivatives used for integration are defined by the <<ContinuousStateDerivative>> elements in <<ModelStructure>>.
