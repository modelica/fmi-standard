...
This attribute defines the delay of the first clock tick relative to latexmath:[t_{\mathit{start}}] (<<startTime>>).
...
|`shiftCounter`
|[[shiftCounter,`shiftCounter`]]This value defines (together with <<resolution>>) the delay of the first clock tick relative to latexmath:[t_{\mathit{start}}] (<<startTime>>):
