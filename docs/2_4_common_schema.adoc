...
|`reinit`
|[[reinit,`reinit`]]
Only for Model Exchange (if only a Co-Simulation or Scheduled Execution FMU, this attribute must not be present.
If both Model Exchange and a Co-Simulation or Scheduled Execution FMU, this attribute is ignored for Co-Simulation and Scheduled Execution): +
