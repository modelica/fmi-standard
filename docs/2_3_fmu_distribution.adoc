...
_[Note,the header files `fmi2TypesPlatform.h` and `fmi2FunctionTypes.h/fmi2Functions.h`
...
call `fmi2GetVersion()` the version number of the header file used to construct
