...
In order to ensure uniqueness the extra files should be provided in sub-directories using a reverse domain name notation
of a domain that is controlled by the entity defining the semantics and content of the additional entries.
