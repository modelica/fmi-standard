...
Each `<BuildConfiguration>` provides the necessary information to compile and link the sources of the model into a dynamic library or as part of an executable for a specific target.
...
----
// TODO: these two includes are currently broken
