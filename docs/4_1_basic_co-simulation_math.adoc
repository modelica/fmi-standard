...
\mathbf{x}_{\mathit{i+1}} = \Phi_i \left( \mathbf{x}_i \left\{ \mathbf{u}_i^{(j)} \right\}_{\mathit{j=0,\cdots,m_{ido}}}, \mathbf{p}_{\mathit{tune,i}}, hc_i  \right)
...
\sum^{m_{\mathit{ido}}}_{\mathit{j=0}} \mathbf{u}^{(j)}_{\mathit{c,i}} \frac{hc^j_i}{j!},
...
[latexmath]
++++
\mathbf{\Phi}_i \left( \mathbf{x}_{\mathit{c,i}}, \left\{ \mathbf{u}_{\mathit{c,i}}^{(j)} \right\}_{\mathit{= 0,\cdots,m_{ido}}},\ \mathbf{p}_{\mathit{tune,i}}, tc_i \right)
=
\mathbf{x}_{\mathit{c,i}} + \left( \mathbf{I} -
hc_i \frac{\partial \mathbf{\varphi}}{\partial \mathbf{x}_c} \right)^{- 1}  hc_i \mathbf{\phi} \left( \mathbf{x}_{\mathit{c,i}}, \mathbf{u}_{\mathit{c,i}}, \mathbf{p}_{\mathit{tune,i}} \right) +
O(hc_i^{2}).
++++
