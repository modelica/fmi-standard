...
- Andreas Junghanns (Synopsys) ans Torsten Blochwitz (ESI-ITI) for restructuring and re-writing the whole FMI standard text.
- all companies and organizations particithat participated in the FMI3.0 Plugfests: Aarhus University, Altair, Augsburg University, AVL, Dassault Systèmes, dSPACE, ESI-ITI, ETAS, Julia Computing, MaplesSoft, OpenMOdelica, PMSF IT Consulting,  Synopsys, TLK
...
Robert Braun, Linköping Uniersity, Sweden
...
Kaska Kowalalska, Maplessoft, Canada
Timo Penndorf, ETAS GmbH, Germany
Tim Schenk, Siemens AG, Germnay
Patrick Täuber, DSPACE, Germany
Adrian Tiera, Synopsys, Romania
Otto Tronarp, Wolfram, Sweden
