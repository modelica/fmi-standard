...
|[[differential-algebraic-equation,differential algebraic equation]]differential algebraic equation
|A differential equation that contains both differential and algebraic equations. Abbreviated as <<DAE>>.
<<DAE,DAEs>> are more general than <<ODE,ODEs>> and are used to describe systems with constraints.
...
<<ECU,ECUs>> are widely used in automotive and other engineering applications for real-time control.
...
This includes <<simulation-tool,simulation tools>>, optimizers, and other software that processes FMUs.

|[[integration-algorithm,integration algorithm]]integration algorithm
|The numerical algorithm to solve differential equations.

|[[integrator,integrator]]integrator
|A software component which implements an <<integration-algorithm,integration algorithm>>.
...
In the context of computer aided design (<<CAD>>), a digital <<DMU>> (<<DMU>>) means a computer-based representation of the product geometry with its parts, usually in 3-D, for all kinds of geometrical and mechanical analyses.
...
|[[ordinary-differential-equation,ordinary differential equation]]ordinary differential equation
...
|[[reverse-DNS,reverse domain name notation]]reverse domain name notation
...
|[[simulation-tool,simulation tool]]simulation tool
|Software application used to develop, configure, and/or execute <<simulation,simulations>> of <<model,models>>. Typically includes model editing, <<solver,solvers>>, execution control, and post-processing.

|[[simulator,simulator]]simulator
|A software application that can include one or more <<simulation-tool,simulation tools>>.

|[[solver,solver]]solver
|Software component which includes algorithms to solve <<model,models>>, for example, <<integration-algorithm,integration algorithms>> and <<event,event>> handling methods.
