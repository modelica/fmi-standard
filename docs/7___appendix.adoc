...
|[[task,task]]_task_
|Special kind of or part of a _model partition_ that represents controller code.
This term is used and defined for example in the embedded systems domain (RTOS, OSEK).
