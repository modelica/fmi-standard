...
A "model class" following the interface type FMI for Model Exchange, or a co-simulation slave following all or any subset of the Co-Simulation interface types (Co-Simulation or Scheduled Co-Simulation).
...
|_xCS_
|Any reference to both Co-Simulation interfaces (CS and SCS) are referred to as Co-Simulation interface.
