...
|A parameter that can be set in <<ConfigurationMode>> before <<InitializationMode>>, e.g.,  for influencing the size and/or dimensionality of an array variable of an FMU.
