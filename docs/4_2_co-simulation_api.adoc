...
Note that *Event Mode* is not supported in Scheduled Co-Simulation.
...
Note that it is not allowed to call <<fmi3EnterEventMode>> or <<fmi3EnterStepMode>> in Scheduled Co-Simulation.
