...
Intermediate variables are variables that are marked with attribute <<intermediateAccess,`intermediateAccess = true`>> in the <<modelDescription.xml>> and have been included in the <<intermediateVariablesSetRequired>> argument to <<fmi3Instantiate>>.
...
Intermediate variables are variables that are marked with attribute <<intermediateAccess,`intermediateAccess = true`>> in the <<modelDescription.xml>> and have been included in the <<intermediateVariablesGetRequired>> argument to <<fmi3Instantiate>>.
