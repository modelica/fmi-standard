...
Common states are defined in <<state-machine-and-common-states>>, such as <<Instantiated,*Instantiated*>>, <<ConfigurationMode,*Configuration Mode*>> and <<InitializationMode,*Initialization Mode*>>.
