...
No new tasks can be started (e.g. related to triggered clock ticks) and all other function calls for this FMU must return `fmi3Error` until the state `Terminated` is reached.
