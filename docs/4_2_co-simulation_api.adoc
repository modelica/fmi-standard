...
[source, C]
----
include::../headers/fmi3FunctionTypes.h[tags=SetRealInputDerivatives]
----
...
[source, C]
----
include::../headers/fmi3FunctionTypes.h[tags=GetRealOutputDerivatives]
----
...
[source, C]
----
include::../headers/fmi3FunctionTypes.h[tags=GetStatus]
----
...
[source, C]
----
include::../headers/fmi3FunctionTypes.h[tags=StatusKind]
----
