...
* `communicationStepSize` is the communication step size (latexmath:[h_i]) with the unit of the <<independent>> variable. `communicationStepSize` must be latexmath:[> 0.0].
