...
+
It is recommended to call `fmi3SetXXX` and `fmi3GetXXX` in the same task as `fmi3ActivateModelPartition()` for setting and retrieving variable values associated to a clock activation.
