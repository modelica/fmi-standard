...
* _FMU~3~ triggers the callback function to the co-simulation algorithm after passing_ latexmath:[t^{'}{i+1}] _, which leads to a request by the co-simulation algorithm to immediately do an early return.
