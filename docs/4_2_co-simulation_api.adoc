...
* _The FMU~2~ unfortunately could not be interrupted before it reached_ latexmath:[t_{i+1}] _, which requires a complete rollback and a new co-simulation from_ latexmath:[t_{i}] _to_ latexmath:[t^{'}_{i+1}] _._
