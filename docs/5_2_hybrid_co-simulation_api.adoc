...
The Co-Simulation master signals to the FMU that it supports and has recognized the early return Co-Simulation capabilities of the FMU by setting the Co-Simulation interface to `fmi3HybridCoSimulation` in the <<fmi3Instantiate>> function.
