...
1. Co-Simulation (fmi3CoSimulation, section 4.2)
2. Early Return (fmi3EarlyReturn, section 4.3)
3. Clocked Co-Simulation (fmi3ClockedCoSimulation, section 4.4)
4. Scheduled Execution Simulation (fmi3ScheduledExecutionSimulation, section 4.5)

Each `fmuType` defines a specific set of features. 
In each co-simulation `fmuType` also the intermediate output value option (4.6) can be activated, if the FMU and the master supports this.
