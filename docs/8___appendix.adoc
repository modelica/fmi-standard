...
|_master algorithm_
|TODO (similar to co-simulation environment?)
...
|_target simulator_
|_TODO (The terms "simulation environment", "calling environment", "target environment", "target platform", are also used. We should unify these. Maybe distinguish between the software and the platform executing it.)
