...
[role=second-indented]
Fixing ticket #86: +
The fmi2TypesPlatform.h header file has been slightly changed: The default value of `fmi2TypesPlatform` is changed from `"standard32"` to `"default"`, since this definition holds for most platforms and compilers.
...
The changes w.r.t. FMI 2.0.3 (clarifications and bugfixes) are summarized on the release page for FMI 2.0.4 https://github.com/modelica/fmi-standard/releases/tag/v2.0.4 
...
#### A.3.8	FMI 2.0.5 maintenance release: changes and contributors
The changes w.r.t. FMI 2.0.4 (clarifications and bugfixes) are summarized on the release page for FMI 2.0.5 https://github.com/modelica/fmi-standard/releases/tag/v2.0.5 
