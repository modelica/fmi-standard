...
For the Backported “Terminals and Icons” and “Build Configuration” Features refere to the contributors list to FMI3.0 https://fmi-standard.org/docs/3.0/#_contributors 
