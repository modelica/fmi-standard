...
The ticking of a _output clock_ may lead to an _<<input>> clock_ tick for another FMU (has to be defined via Co-Simulation master) or for a model partition of the same FMU (is defined in modelDescription.xml).
