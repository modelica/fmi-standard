...
In order to handle <<input>> clocks, the Co-Simulation master schedules <<input>> clocks and adjusts the communication steps in such a way that <<inputClock>> ticks become communication points.
