...
_However, in FMI 3.0, Hybrid Co-Simulation (HCS) and Scheduled Co-Simulation (CSC) may likely be more suitable for this use-case.]_
...
==== Scheduled Co-Simulation interface [[math-scheduled-co-simulation]]
