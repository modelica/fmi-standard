...
In the case of FMU~3~, a partial rollback is necessary.
In the case of FMU~4~, the current `{DOSTEP}` has been interrupted at latexmath:[t^{'}_{i+1}] and no rollback is necessary.
