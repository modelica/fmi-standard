...
The master can try to repeat the step with other input values and/or a different communication step size, but has to re-initialize the state by either <<fmi3SetState>> or terminating and reinitializing the instance.
