This document defines the Functional Mock-up Interface (FMI), version 3. This is a major release with new features compared to FMI 2.0.
...
FMI 2.0.1 is a maintenance release with no new features compared to FMI 2.0.
