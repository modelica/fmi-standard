...
It is supported by https://fmi-standard.org/tools/[more than 230 tools] and maintained as a https://www.modelica.org/association/[Modelica Association Project] (<<MAP>>) FMI.
...
Copyright (C) 2008-2011 MODELISAR Consortium and 2012-2026 The Modelica Association Project FMI.
