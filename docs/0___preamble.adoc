...
[[MAP,MAP]]It is supported by https://fmi-standard.org/tools/[more than 220 tools] and maintained as a https://www.modelica.org/projects[Modelica Association Project] (MAP FMI).
