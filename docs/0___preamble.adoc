This document defines the Functional Mock-up Interface (FMI), version 2.0.1. This is a maintenance release with no new features compared to FMI 2.0.
...
version 2.0.1 to (a) exchange dynamic models between tools and (b) define tool
...
** _[Clarification for FMI 2.0.2: In the structure naming convention both 0- and 1-based arrays are allowed.]_
