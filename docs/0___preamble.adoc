This document defines the Functional Mock-up Interface (FMI), version 2.0.5. This is a maintenance release for FMI 2.0.
...
FMI 2.0 is supported by more than 200 tools and is used by automotive and non-automotive organizations throughout Europe, Asia and North America.
...
version 2.0.5 to (a) exchange dynamic models between tools and (b) define tool
