...
In the XML file, also information about the capabilities of the FMU is present, for example to characterize the ability of a xCS FMU to support advanced master algorithms such as the usage of variable communication step sizes, higher order signal extrapolation, or others.
