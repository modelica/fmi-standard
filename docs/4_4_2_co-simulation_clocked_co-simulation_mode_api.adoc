...
The simulation master sets and gets clock variable values exactly similar to FMI for ModelExchange, as defined in <<fmi-api-setting-getting-clock-activation-state>> #[TODO] section 4.2 + section "setting/getting clock activation state" in 2.2#.
