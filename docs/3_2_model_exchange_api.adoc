...
If `enterEventMode == fmi3False` and <<terminateSimulation,`terminateSimulation == fmi3False`>> the FMU stays in *Continuous-Time Mode* without calling <<fmi3EnterContinuousTimeMode>> again.
