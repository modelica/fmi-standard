...
[source, C]
----
fmi3Status fmi3SetTime(fmi3Component component, fmi3Real time);
----
[role=indented2]
...
[source, C]
----
fmi3Status fmi3SetContinuousStates(fmi3Component component, const fmi3Real x[], size_t nx);
----
[role=indented2]
...
[source, C]
----
fmi3Status fmi3EnterEventMode(fmi3Component component);
----
[role=indented2]
...
[source, C]
----
fmi3Status fmi3NewDiscreteStates(fmi3Component component, fmi3EventInfo* eventInfo);
...
[source, C]
----
fmi3Status fmi3EnterContinuousTimeMode(fmi3Component component);
----
...
[source, C]
----
fmi3Status fmi3CompletedIntegratorStep(fmi3Component component,
...
[source, C]
----
fmi3Status fmi3GetDerivatives    (fmi3Component component, fmi3Real derivatives[], size_t nx);
fmi3Status fmi3GetEventIndicators(fmi3Component component, fmi3Real eventIndicators[], size_t nz);
----
...
[source, C]
----
fmi3Status fmi3GetContinuousStates(fmi3Component component, fmi3Real x[], size_t nx);
----
...
[source, C]
----
fmi3Status fmi3GetNominalsOfContinuousStates(fmi3Component component, fmi3Real x_nominal[], size_t nx);
----
