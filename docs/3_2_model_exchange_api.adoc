...
** [[dynamic-state-selection, dynamic state selection]] For dynamic state selection the FMU checks whether the dynamically selected states are still numerically appropriate.
