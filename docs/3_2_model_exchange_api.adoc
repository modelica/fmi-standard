...
* Model Exchange only: `nEventIndicators` contains the number of event indicators as deduced from the list `<ModelStructure><EventIndicator>` or `0` if the importer cannot provide this information.
