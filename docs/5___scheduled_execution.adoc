...
* The scheduler can run model partitions of one FMU together with model partitions of other FMUs or model partitions from other source such as other models or functions in a single process.
