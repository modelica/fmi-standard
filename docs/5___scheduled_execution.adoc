...
With <<scheduled-execution-api,Scheduled Execution>> a simulation master can directly control the time of computation (i.e. scheduling) for such model partitions.
