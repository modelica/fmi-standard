...
latexmath:[\mathbf{v}_{start}], latexmath:[\mathbf{u}], latexmath:[\mathbf{y}], latexmath:[\mathbf{w}], latexmath:[\mathbf{x}_d] are of a numeric type or String;
latexmath:[\mathbf{t}], latexmath:[\mathbf{x}_c], latexmath:[\mathbf{z}] are of float type.
