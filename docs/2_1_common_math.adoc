...
|`d`
|A discrete-time variable changes its value only at event instants latexmath:[t = (t_i,n)].
...
* The communication step size is denoted as latexmath:[\mathbf{h}_i = t_{i+1} - t_i]. +
