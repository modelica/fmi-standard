...
a|previous value, either

* left limit or
* value from the previous super-dense time instant or
* for clocked variables the value computed at the previous clock activation time.
|====
