...
<ModelVariables>
  ...
  <Float64 name="POWERTRAIN::ecuState::ecuState::radiatorTemp" valueReference="1013" causality="output" variability="discrete" start="0"/>
  <Binary  name="POWERTRAIN::ecuState_FRAME"                   valueReference="1014" causality="output" variability="discrete" start="0"/>
  <Clock   name="POWERTRAIN::ecuState_CLOCK"                   valueReference="1015" causality="output" variability="clock" interval="triggered"/>
</ModelVariables>
<ModelStructure>
  <Clock valueReference="1004" clockedVariables="1001 1002 1003"/>
  <Clock valueReference="1009" clockedVariables="1005 1006 1007 1008"/>
  <Clock valueReference="1015" clockedVariables="1010 1011 1012 1013 1014"/>
</ModelStructure>
----
