=== Scheduled Co-Simulation Application Programming Interface [[scheduled-co-simulation-api]]
...
In `fmi3ScheduledCoSimulation` the handling of <<fmi3CallbackIntermediateUpdate>> callbacks is the same as in section <<hybrid-co-simulation>>.
