...
- Write XML elements like this: `<MyElement>`. And XML attributes like this `myAttribute`. Just like you write C identifier (variables, structures, their elements and function names). Except in headings: There do not use any formatting.

- In headings, do not use any formatting. 
