...
- as File name select `FMI_for_ModelExchange_and_CoSimulation_v2.0.1.pdf`
+
...
- save the PDF as `FMI_for_ModelExchange_and_CoSimulation_v2.0.1_with_change_marks_to_v2.0.pdf`
...
schema
CHANGELOG.adoc
FMI_for_ModelExchange_and_CoSimulation_v2.0.1.pdf
FMI_for_ModelExchange_and_CoSimulation_v2.0.1_with_change_marks_to_v2.0.pdf
LICENSE.txt
----

- right-click and select `Send to > Compressed (zipped) folder`

- name the file `FMI_for_ModelExchange_and_CoSimulation_v2.0.1.zip`
