...
=== Creating the PDFs from the Word document

== Exporting the PDF document

- Open *.docx in Word 2016
- Select File --> Export --> Create PDF/XPS Document --> Create PDF/XPS
- TODO options: Publish word document (Screenshot) 
- Select "for publishing and web" 
- Press "Publish"

== Create Diff

- In Review Tab select "Compare"
- TODO insert 2 screenshots
- Original document 2.0, Revisd document XXX_RC.docx
- Show Markup --> Baloons --> Show all revisions inline

- From this export a PDF as above but with selecting "Publish word document showing markup" 
