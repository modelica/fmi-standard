...
`Alternative 2:` Ruby, the AsciiDoctor gem and the AsciiDoctor-latex gem

. https://www.ruby-lang.org/en/downloads/[Install Ruby]

. Install the https://asciidoctor.org/#installation[AsciiDoctor Ruby gem]

. Install the https://github.com/asciidoctor/asciidoctor-latex#3-installation[AsciiDoctor-latex gem]

. Generate the HTML document
+
  asciidoctor-latex -B <fmi-standard> -b html5 docs/fmi_specification.adoc
+
where `<fmi-standard>` is the path to the cloned repository
